...
\restrict xGdGd0GdmwHBJ4lAGBOqNghLVb49tA2xqeeOXhohLj2JaOTxbLq83hOlPc9c56B

-- Dumped from database version 18.1 (Debian 18.1-1.pgdg12+2)
-- Dumped by pg_dump version 18.0

-- Started on 2026-01-02 11:19:54 CST
...
-- Name: company; Type: TABLE; Schema: public; Owner: postgres_user
--
...
ALTER TABLE public.company OWNER TO postgres_user;

--
-- TOC entry 228 (class 1259 OID 16882)
-- Name: company_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres_user
--
...
-- Name: company_user; Type: TABLE; Schema: public; Owner: postgres_user
--
...
ALTER TABLE public.company_user OWNER TO postgres_user;
...
CREATE TABLE public.origin (
    id integer CONSTRAINT origin_new_id_not_null NOT NULL,
    company_id integer,
    domain text CONSTRAINT origin_new_domain_not_null NOT NULL,
    origin_lang text CONSTRAINT origin_new_origin_lang_not_null NOT NULL,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now()
);
...
-- Name: origin_new_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres_user
--

ALTER TABLE public.origin ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.origin_new_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.translated_path (
    id integer CONSTRAINT translated_path_new_id_not_null NOT NULL,
    origin_path_id integer CONSTRAINT translated_path_new_origin_path_id_not_null NOT NULL,
    lang text CONSTRAINT translated_path_new_lang_not_null NOT NULL,
    translated_path text CONSTRAINT translated_path_new_translated_path_not_null NOT NULL,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now()
);
...
--
-- TOC entry 235 (class 1259 OID 17076)
-- Name: translated_path_new_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres_user
--

ALTER TABLE public.translated_path ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.translated_path_new_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.translated_segment (
    id integer CONSTRAINT translated_segment_new_id_not_null NOT NULL,
    origin_segment_id integer CONSTRAINT translated_segment_new_origin_segment_id_not_null NOT NULL,
    lang text CONSTRAINT translated_segment_new_lang_not_null NOT NULL,
    translated_text text CONSTRAINT translated_segment_new_translated_text_not_null NOT NULL,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now()
);
...
--
-- TOC entry 233 (class 1259 OID 17053)
-- Name: translated_segment_new_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres_user
--

ALTER TABLE public.translated_segment ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.translated_segment_new_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 3276 (class 2604 OID 16442)
...
--
-- TOC entry 3284 (class 2604 OID 16687)
...
--
-- TOC entry 3282 (class 2604 OID 16666)
...
--
-- TOC entry 3273 (class 2604 OID 16403)
...
--
-- TOC entry 3321 (class 2606 OID 16893)
-- Name: company company_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres_user
--
...
--
-- TOC entry 3323 (class 2606 OID 16906)
-- Name: company_user company_user_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres_user
--
...
--
-- TOC entry 3327 (class 2606 OID 16932)
-- Name: origin origin_new_domain_key; Type: CONSTRAINT; Schema: public; Owner: postgres_user
--

ALTER TABLE ONLY public.origin
    ADD CONSTRAINT origin_new_domain_key UNIQUE (domain);


--
-- TOC entry 3329 (class 2606 OID 16930)
-- Name: origin origin_new_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres_user
--

ALTER TABLE ONLY public.origin
    ADD CONSTRAINT origin_new_pkey PRIMARY KEY (id);


--
-- TOC entry 3313 (class 2606 OID 16697)
...
--
-- TOC entry 3315 (class 2606 OID 16695)
...
--
-- TOC entry 3319 (class 2606 OID 16823)
...
--
-- TOC entry 3310 (class 2606 OID 16675)
...
--
-- TOC entry 3337 (class 2606 OID 17091)
-- Name: translated_path translated_path_new_origin_path_id_lang_key; Type: CONSTRAINT; Schema: public; Owner: postgres_user
--

ALTER TABLE ONLY public.translated_path
    ADD CONSTRAINT translated_path_new_origin_path_id_lang_key UNIQUE (origin_path_id, lang);


--
-- TOC entry 3339 (class 2606 OID 17089)
-- Name: translated_path translated_path_new_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres_user
--

ALTER TABLE ONLY public.translated_path
    ADD CONSTRAINT translated_path_new_pkey PRIMARY KEY (id);


--
-- TOC entry 3332 (class 2606 OID 17068)
-- Name: translated_segment translated_segment_new_origin_segment_id_lang_key; Type: CONSTRAINT; Schema: public; Owner: postgres_user
--

ALTER TABLE ONLY public.translated_segment
    ADD CONSTRAINT translated_segment_new_origin_segment_id_lang_key UNIQUE (origin_segment_id, lang);


--
-- TOC entry 3334 (class 2606 OID 17066)
-- Name: translated_segment translated_segment_new_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres_user
--

ALTER TABLE ONLY public.translated_segment
    ADD CONSTRAINT translated_segment_new_pkey PRIMARY KEY (id);
...
--
-- TOC entry 3324 (class 1259 OID 16917)
-- Name: idx_company_user_user_id; Type: INDEX; Schema: public; Owner: postgres_user
--

CREATE INDEX idx_company_user_user_id ON public.company_user USING btree (user_id);


--
-- TOC entry 3305 (class 1259 OID 16462)
...
--
-- TOC entry 3325 (class 1259 OID 16938)
-- Name: idx_origin_company_id; Type: INDEX; Schema: public; Owner: postgres_user
--

CREATE INDEX idx_origin_company_id ON public.origin USING btree (company_id);


--
-- TOC entry 3311 (class 1259 OID 16760)
...
--
-- TOC entry 3316 (class 1259 OID 16820)
...
--
-- TOC entry 3306 (class 1259 OID 16759)
...
--
-- TOC entry 3335 (class 1259 OID 17097)
...
--
-- TOC entry 3330 (class 1259 OID 17074)
...
--
-- TOC entry 3352 (class 2620 OID 16894)
-- Name: company company_updated_at; Type: TRIGGER; Schema: public; Owner: postgres_user
--

CREATE TRIGGER company_updated_at BEFORE UPDATE ON public.company FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- TOC entry 3351 (class 2620 OID 16463)
...
--
-- TOC entry 3353 (class 2620 OID 16939)
...
--
-- TOC entry 3355 (class 2620 OID 17098)
-- Name: translated_path translated_path_updated_at; Type: TRIGGER; Schema: public; Owner: postgres_user
--

CREATE TRIGGER translated_path_updated_at BEFORE UPDATE ON public.translated_path FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- TOC entry 3354 (class 2620 OID 17075)
...
--
-- TOC entry 3350 (class 2620 OID 16414)
...
--
-- TOC entry 3345 (class 2606 OID 16907)
-- Name: company_user company_user_company_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres_user
--

ALTER TABLE ONLY public.company_user
    ADD CONSTRAINT company_user_company_id_fkey FOREIGN KEY (company_id) REFERENCES public.company(id) ON DELETE CASCADE;


--
-- TOC entry 3346 (class 2606 OID 16912)
-- Name: company_user company_user_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres_user
--

ALTER TABLE ONLY public.company_user
    ADD CONSTRAINT company_user_user_id_fkey FOREIGN KEY (user_id) REFERENCES public."user"(id) ON DELETE CASCADE;


--
-- TOC entry 3340 (class 2606 OID 16940)
...
--
-- TOC entry 3347 (class 2606 OID 16933)
-- Name: origin origin_new_company_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres_user
--

ALTER TABLE ONLY public.origin
    ADD CONSTRAINT origin_new_company_id_fkey FOREIGN KEY (company_id) REFERENCES public.company(id) ON DELETE CASCADE;


--
-- TOC entry 3342 (class 2606 OID 16950)
...
--
-- TOC entry 3343 (class 2606 OID 16810)
...
--
-- TOC entry 3344 (class 2606 OID 16815)
...
--
-- TOC entry 3349 (class 2606 OID 17092)
-- Name: translated_path translated_path_new_origin_path_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres_user
--

ALTER TABLE ONLY public.translated_path
    ADD CONSTRAINT translated_path_new_origin_path_id_fkey FOREIGN KEY (origin_path_id) REFERENCES public.origin_path(id) ON DELETE CASCADE;


--
-- TOC entry 3348 (class 2606 OID 17069)
-- Name: translated_segment translated_segment_new_origin_segment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres_user
--

ALTER TABLE ONLY public.translated_segment
    ADD CONSTRAINT translated_segment_new_origin_segment_id_fkey FOREIGN KEY (origin_segment_id) REFERENCES public.origin_segment(id) ON DELETE CASCADE;
...
-- Completed on 2026-01-02 11:20:02 CST

--
-- PostgreSQL database dump complete
--

\unrestrict xGdGd0GdmwHBJ4lAGBOqNghLVb49tA2xqeeOXhohLj2JaOTxbLq83hOlPc9c56B
